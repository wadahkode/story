...
function storyComponent(props) {
  if (localStorage.getItem("data")) {
    props.data = JSON.parse(localStorage.getItem("data"));
  }
...
const editorStory = document.querySelector(".editor-story");
const titleStory = document.querySelector(".title-story");

if (editorStory == undefined) {
  //
} else {
  editorStory.addEventListener("keyup", (event) => {
